...
post_data_exchange_test() ->
	...
	fun() ->
		...
		api_help:refresh(),
		{200, Body1} = http:post(?WEBMACHINE_URL++"/streams", "{\"name\":\"Stream1\",\"user_id\":\""++User1++"\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"),
		{200, Body2} = http:post(?WEBMACHINE_URL++"/streams", "{\"name\":\"Stream2\",\"user_id\":\""++User1++"\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"),
		api_help:refresh(),
...
post_data_user_test() ->
	...
	{ok, {{_Version2, 200, _ReasonPhrase2}, _Headers2, Body2}} = httpc:request(post, {?WEBMACHINE_URL++"/streams", [],"application/json", "{\"name\" : \"Stream2\",\"user_id\":\"tomas\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"}, [], []),
...
post_data_exchange_vstream_test() ->
	...
	fun() ->
		...
		http:post(?WEBMACHINE_URL++"/users", "{\"username\" : \""++User2++"\"}"),
		api_help:refresh(),
		{200, SBody1} = http:post(?WEBMACHINE_URL++"/streams", "{\"name\":\"Stream1\",\"user_id\":\""++User1++"\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"),
		{200, SBody2} = http:post(?WEBMACHINE_URL++"/streams", "{\"name\":\"Stream2\",\"user_id\":\""++User1++"\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"),
		api_help:refresh(),
...
post_data_user_vstream() ->
    ...
    httpc:request(post, {?WEBMACHINE_URL++"/users", [],"application/json", "{\"username\" : \""++User2++"\"}"}, [], []),
	api_help:refresh(),
	{ok, {{_Version1, 200, _ReasonPhrase1}, _Headers1, SBody1}} = httpc:request(post, {?WEBMACHINE_URL++"/streams", [],"application/json", "{\"name\" : \"Stream1\",\"user_id\":\"tomas\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"}, [], []),
	{ok, {{_Version2, 200, _ReasonPhrase2}, _Headers2, SBody2}} = httpc:request(post, {?WEBMACHINE_URL++"/streams", [],"application/json", "{\"name\" : \"Stream2\",\"user_id\":\"tomas\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"}, [], []),
	StreamId1 = lib_json:to_string(lib_json:get_field(SBody1,"_id")),
	StreamId2 = lib_json:to_string(lib_json:get_field(SBody2,"_id")),
	api_help:refresh(),
	{200, Body1} = http:post(?WEBMACHINE_URL++"/vstreams", "{\"user_id\":\""++User1++"\",\"name\":\"VStream1\",\"tags\":\"average,temperature,celsius,uppsala\",\"description\":\"Diff\",\"private\":\"false\",\"timestampfrom\" : \"now-1w\",\"streams_involved\": [\"" ++ StreamId1 ++ "\"],\"function\":[\"diff\", \"2s\"]}"),
