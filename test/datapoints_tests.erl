...
update_stream_fields_test() ->
	...
	api_help:refresh(),
	{ok, {{_Version1, 200, _ReasonPhrase1}, _Headers1, Body1}} = httpc:request(post, {?WEBMACHINE_URL++"/streams", [],"application/json", "{\"name\" : \"search\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\", \"user_id\" : \"update_stream_user\", \"private\" : \"false\"}"}, [], []),
