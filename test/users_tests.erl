...
delete_user_test() ->
	...
	api_help:refresh(),
	{ok, {{_Version5, 200, _ReasonPhrase5}, _Headers5, Body5}} = httpc:request(post, {?STREAMS_URL, [],"application/json", "{\"name\" : \"delete\", \"user_id\" : \"test33\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\" }"}, [], []),
	{ok, {{_Version6, 200, _ReasonPhrase6}, _Headers6, Body6}} = httpc:request(post, {?STREAMS_URL, [],"application/json", "{\"name\" : \"delete\", \"user_id\" : \"test33\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"}, [], []),
	{ok, {{_Version7, 200, _ReasonPhrase7}, _Headers7, Body7}} = httpc:request(post, {?STREAMS_URL, [],"application/json", "{\"name\" : \"delete\",\"user_id\" : \"test22\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"}, [], []),
	{ok, {{_Version8, 200, _ReasonPhrase8}, _Headers8, Body8}} = httpc:request(post, {?STREAMS_URL, [],"application/json", "{\"name\" : \"delete\",\"user_id\" : \"test22\", \"min_val\": \"0.0\" , \"max_val\": \"1.0\"}"}, [], []),
